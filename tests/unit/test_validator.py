...
def test_validate_rejects_spine_with_unresolved_idref() -> None:
    ...
    from epub_translation_prepare.epub.model import SpineRef
    from epub_translation_prepare.epub.reader import read_epub_bytes
    from epub_translation_prepare.epub.validator import validate_epub
...
def test_check_output_not_exists_raises_when_exists(
    ...
    from epub_translation_prepare.epub.validator import check_output_not_exists
...
def test_check_output_not_input_raises_on_collision(tmp_path: pathlib.Path) -> None:
    ...
    from epub_translation_prepare.epub.validator import check_output_not_input

...
def test_parser_blocks_network_access() -> None:
    ...
    from epub_translation_prepare.epub._safe_parser import xml_parser
...
def test_html_parser_is_safe() -> None:
    ...
    from epub_translation_prepare.epub._safe_parser import html_parser
...
def test_parse_html_document_succeeds_on_html5() -> None:
    ...
    from epub_translation_prepare.epub._safe_parser import parse_html_document
